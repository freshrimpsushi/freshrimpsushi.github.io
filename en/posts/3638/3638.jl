...
function show_img(t_view, xts, cd, num)
    ...
    rgb_img = colorview(RGB, img_CHW)       # reinterpret 성공
    display(rgb_img)
    filename = joinpath(cd, "3638_$(num).png")
...
show_img(50, xts, cd, 2)

show_img(100, xts)
save(cd*"./3638_3.png", rgb_img)   # save as png

show_img(150, xts)
save(cd*"./3638_4.png", rgb_img)   # save as png

show_img(300, xts)
save(cd*"./3638_5.png", rgb_img)   # save as png

show_img(500, xts)
save(cd*"./3638_6.png", rgb_img)   # save as png


show_img(1000, xts)
save(cd*"./3638_7.png", rgb_img)   # save as png